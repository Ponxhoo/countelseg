<div class="geex-sidebar">
  ...
  <g clip-path="url(#clip0)">
    <path d="M2 10H12C12.6 10 13.1 9.8 13.5 9.4C13.9 9 14 8.6 14 8V2C14 1.4 13.9 1 13.5 0.6C13.1 0.2 12.6 0 12 0H2C1.4 0 1 0.2 0.6 0.6C0.2 1 0 1.4 0 2V8C0 8.6 0.2 9 0.6 9.4C1 9.8 1.4 10 2 10ZM2 2H12V8H2V2Z" fill="#007BFF"/>
    <path d="M21 0H18C17.4 0 17 0.2 16.6 0.6C16.2 1 16 1.4 16 2V8C16 8.6 16.2 9 16.6 9.4C17 9.8 17.4 10 18 10H21C21.6 10 22 9.8 22.4 9.4C22.8 9 23 8.6 23 8V2C23 1.4 22.8 1 22.4 0.6C22 0.2 21.6 0 21 0ZM21 8H18V2H21V8Z" fill="#007BFF"/>
    <path d="M5 12H2C1.4 12 1 12.2 0.6 12.6C0.2 13 0 13.4 0 14V21C0 21.6 0.2 22 0.6 22.4C1 22.8 1.4 23 2 23H5C5.6 23 6 22.8 6.4 22.4C6.8 22 7 21.6 7 21V14C7 13.4 6.8 13 6.4 12.6C6 12.2 5.6 12 5 12ZM5 21H2V14H5V21Z" fill="#007BFF"/>
    <path d="M21 12H11C10.4 12 10 12.2 9.6 12.6C9.2 13 9 13.4 9 14V21C9 21.6 9.2 22 9.6 22.4C10 22.8 10.4 23 11 23H21C21.6 23 22 22.8 22.4 22.4C22.8 22 23 21.6 23 21V14C23 13.4 22.8 13 22.4 12.6C22 12.2 21.6 12 21 12ZM21 21H11V14H21V21Z" fill="#007BFF"/>
  </g>
  <defs>
    <clipPath id="clip0">
      <rect width="22" height="22" fill="white"/>
